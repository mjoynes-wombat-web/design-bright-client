  ...
  return (
    <main id="references">
      <section className="main-content">
        <div>
          <Heading type="h1" text="References" />
          <div>
            <Heading type="h2" text="All Pages" />
          ...
          <p class="remaining-content-references">All other content was created by Simeon Smith © 2017.</p>
        </div>
      </section>
    </main>
  );
